...
def test_execute(request, args):
    ...
    # failure
    interactions = others[1].result.interactions
    ...
    # success
    interactions = others[3].result.interactions
    ...
    assert json.loads(base64.b64decode(success.response.content)) == {"success": True}
    if isinstance(app, Flask):
